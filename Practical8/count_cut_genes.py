...
file_opened=open("/Users/yiyi/Desktop/IBI1_2021-22/Practical8/count_cut_gene.fa") # open the file created by myself
...
# create a file that will store the gene name, number of cuts and DNA sequences
with open("/Users/yiyi/Desktop/IBI1_2021-22/Practical8/cut_genes.fa",'w') as f: 
    f.writelines(count_cut_genes) # write contents
f_opened=open("/Users/yiyi/Desktop/IBI1_2021-22/Practical8/cut_genes.fa") #open the file 
